...
public final class ErrorLogger {
   ...
   */
  // Methods
  public final void logError(final Throwable e) {
    final ErrorWriter ew = new ErrorWriter(e, this.name, ErrorLogger.calendar);
    ew.writeErrorInfo();
    System.exit(1);
  }
   ...
   *          the exception to log
   */
  public final void logWarning(final Throwable e) {
